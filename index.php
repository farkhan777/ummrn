...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top" style=<?php echo"$navigate";?>>
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.php"><img src="images/logo.png" alt="alternative"
                style="height:70px;" /></a>
    ...
    <div class="copyright">
        <div class="container ">
            <p class="p-small py-4">Copyright © 2020 <b>UMM RESEARCH NETWORKS</b> <a
                    href="https://inovatik.com">Designed by
                    Inovatik</a></p>
