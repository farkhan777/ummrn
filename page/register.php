            ...
            <div class="row py-5 my-5">
                <div class="col-lg-5 ">
                    <div class="text-container">
                        ...
                        <form name="RegForm" method="POST" action="index.php?page=registeraction">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control-input" name="nim" value="" id="cemail"
                                    required>
                                <label class="label-control" for="cemail">Student ID</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="number" class="form-control-input" name="phone" value="" id="cname"
                                    required>
                                <label class="label-control" for="cname">Phone</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control-input" name="email" value="" id="cemail"
                                    required>
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control-input" name="psw" value="" id="psws"
                                    required>
                                <label class="label-control" for="cemail">Password</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control-input" name="psw" value="" id="pswsnew"
                                    required>
                                <label class="label-control" for="cemail">Confirm Password</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control-textarea" name="description" id="cmessage"
                                    required></textarea>
                                <label class="label-control" for="cmessage">About you</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group checkbox">
                                <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I agree with UMMRN's
                                Terms and Serices</a>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-7">
                    ...
                    <p style="line-height:35px;"><b>Please read carefully before using the UMMRN Services:</b> <br />
                        1. UMMRN only provides service, not content. UMMRN is not responsible for all data that has been
                        submitted to the application.<br />
                        2. The member must be registered at Universitas Muhammadiyah Malang, either as lecturers of
                        students. <br />
