    <div class="container">
        ...
        <div style="width:100%; padding-top:50px;">
            ...
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg" style="margin-top:3px;">
                        ...
                        <i class="fas fa-envelope"></i> <a style="text-decoration:none;"href="mailto:ilyas@umm.ac.id">ilyas@umm.ac.id</a></li>
                    </ul>
            ...
            <div class="col-lg-6">
                <?php
                    include"koneksi.php";
                    $sql="select * from students where id_student=$_SESSION[userid]";
                    $query=mysqli_query($koneksi,$sql);
                    $id=$_GET['id'];
                    while($row=mysqli_fetch_array($query,MYSQLI_NUM)){
                    echo"
